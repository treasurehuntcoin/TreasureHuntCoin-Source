...
uint256 hashGenesisBlock("0x000003c1ec9be5abe8f7752e77e9e125c58d8473517fc962a2ecc26f35e4e250");
static CBigNum bnProofOfWorkLimit(~uint256(0) >> 20); // TreasureHuntCoin: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "TreasureHuntCoin Signed Message:\n";
...
{
    // TreasureHuntCoin: IsDust() detection disabled, allows any valid dust to be relayed.
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    // Subsidy is cut in half every 400280 blocks
    nSubsidy >>= (nHeight / 400280); // TreasureHuntCoin: 400280

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 24 * 60 * 60; // TreasureHuntCoin: 1 day
static const int64 nTargetSpacing = 2.6 * 60; // TreasureHuntCoin: 2.6 minutes
...
unsigned int static GetNextWorkRequired_V1(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    // TreasureHuntCoin: This fixes an issue where a 51% attack can change difficulty at will.
...
{
        static const int64 BlocksTargetSpacing = 2.6 * 60; // TreasureHuntCoin: 2.6 minute
        static const unsigned int TimeDaySeconds = 24 * 60 * 60; // TreasureHuntCoin: 1 day
...
{
    // TreasureHuntCoin: temporarily disable v2 block lockin until we are ready for v2 transition
    return false;
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x000003c1ec9be5abe8f7752e77e9e125c58d8473517fc962a2ecc26f35e4e250");
    }
...
bool InitBlockIndex() {
    ...
    // vMerkleTree: b0019d92bc054f7418960c91e252e7d24c77719c7a30128c5f6a827c73095d2a 
		...
		const char* pszTimestamp = "Treasure hunt coin";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1398890133;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 1178993;
 ...
 if (false && block.GetHash() != hashGenesisBlock)
        ...
        assert(block.hashMerkleRoot == uint256("0x8cca6f80515dead181edc12fe8de73e0093a78ffbe1f6cdb4dfa5354ec39729b"));
...
unsigned char pchMessageStart[4] = { 0xfe, 0xc3, 0xb9, 0xde }; // TreasureHuntCoin: increase each by adding 6 to bitcoin's value.
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("TreasureHuntCoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("TreasureHuntCoinMiner : ProcessBlock, block not accepted");
    }
